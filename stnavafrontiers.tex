...
As part of our work in ITK refactoring, we built, in parallel, an
...
\href{http://stnava.github.io/ANTs}{(link)}. 

While it is not possible to solve all registration problems with a
general framework, our general optimization-driven strategies have
