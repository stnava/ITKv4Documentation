...
\section{Enabling Diverse Applications of the ITK$^4$ Framework}
...
This contribution is valuable because of the tremendous range of
possible registration problems.  While it is not possible to solve all registration problems with a
...
\begin{enumerate}
  \item~The \href{https://github.com/stnava/BasicBrainMapping}{Basic
      Brain Mapping} example shows how one can map two ``whole head''
    T1-weighted MRI where one is a template with some user-based prior
    knowledge defining the ``interesting'' parts of the image.
    Furhermore, a second part of this example shows how the ITK
  ...
  \item~time series data
    \href{https://github.com/stnava/ANTs/blob/master/Scripts/antsMotionCorrExample}{here}. % done

   \item~ An advanced example with heavy use of statistics via {\em
       R} and \href{http://stnava.github.io/ANTsR/}{{\em ANTsR}} is
       \href{http://stnava.github.io/RfMRI/}{fmri analysis} on public data. % done

  \item~classic car example \href{http://stnava.github.io/cars/}{here}. % done
  ...
  \item~A basic \href{http://stnava.github.io/butterfly/}{multistart example}.  A more advanced
    ...
    {\em antsCorticalThickness.sh}. % done
...
\noindent{\bf Image registration should be achievable in one step:}
...
\noindent{\bf Registration mappings should be applicable to a number of popular data
types, including DTI:}
...
\noindent{\bf Affine and deformable similarity metrics should look as similar as possible:}
...
\noindent{\bf Users should be able to combine multiple similarity metrics, some of which may operate on different data types: }
...
\noindent{\bf Flexible choice of optimizers and transformations:  }
...
\noindent{\bf GPU and multi-core acceleration will open up new applications for image registration:  }
...
\noindent{\bf Improved performance:}
...
\noindent{\bf Other technical advances:}
