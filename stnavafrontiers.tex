...
\caption{Three references images, $I$
...
and BRAINSFit each use a different similarity metric, strategy for
rigid/affine registration and optimizer making this overall comparison
less than ideal.
