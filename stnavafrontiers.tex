...
to facilitate parameter tuning across metrics.  The latest evaluation
numbers are at:
...
features, etc and the different resolutions at which this should be done.  By the time of the
...
\section{Appendix: ITK$^4$ Details}
