...
\begin{eqnarray}
 M_{p_i}=\frac{\partial M}{\partial
  ...
  J(\phi(x,p))}{\partial \phi} \frac{\partial \phi}{\partial p_i}|^T_x
~~.
\label{eq:grad}
\end{eqnarray}
...
In the future, the latest evaluation numbers will be available at github.com/stnava/ITKv4Documentation.
...
FIXME SEGMENTATION EVAL As shown in figure~\ref{fig:result}, very similar results are achieved
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=3.5in]{figs/eval_brain.pdf}
